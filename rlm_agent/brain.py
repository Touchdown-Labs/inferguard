"""InferGuard v6 L3 brain (direct GMI call with RLM integration)."""
...
from rlm_agent.daytona_client import DaytonaClient
from rlm_agent.rlm_decomposer import RlmDecomposer

log = structlog.get_logger()


class InferGuardBrain:
    """RLM agent brain that returns proactive advisory dicts."""
...
"""
    ...
    def _normalize(self, raw: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "advisory_only": True,
            "source": str(raw.get("source") or "rlm_brain"),
        }
