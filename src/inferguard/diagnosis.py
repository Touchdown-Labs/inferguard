...
class DiagnosisResult:
    ...
    def as_dict(self) -> dict[str, object]:
        return {
            ...
            "actuation_recommendation": self.actuation_recommendation,
        }
...
Return JSON with exactly:
{
  ...
  "actuation_recommendation": "safe_to_actuate" | "manual_review" | "do_not_actuate"
}
...
async def diagnose(
    ...
    return DiagnosisResult(
        ...
        actuation_recommendation=str(parsed.get("actuation_recommendation", "manual_review")),
    )
