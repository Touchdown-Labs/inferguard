...
description: How launch, request timing, metrics, validation, and reports fit together.
---

This page is the operator-oriented architecture overview. The detailed schema and historical architecture authority remains [the specification](spec.md); this page is intentionally shorter and optimized for OSS readers deciding how the pieces fit together.
...
- Update [CLI reference](../reference/cli.md) when command help changes.
- Update [hardware coverage](../reference/hardware-coverage.md) when matrix coverage changes.
- Keep private/pro-tier modules outside the OSS import graph; see the public [repository](https://github.com/Touchdown-Labs/inferguard).
