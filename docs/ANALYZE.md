...
`report.json` uses schema version `inferguard-analyze/v1`. See [SCHEMAS.md](SCHEMAS.md) for the normative field contract.
...
Detailed input requirements are in [SUPPORTED_INPUTS.md](SUPPORTED_INPUTS.md).
