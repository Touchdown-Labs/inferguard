...
# Agentic trace replay benchmark for DeepSeek-V4-Flash FP8 on H100 using vLLM.
# DSv4-Pro does not fit on a single 8xH100-80G node; this recipe retargets Flash.
